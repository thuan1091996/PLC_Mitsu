...
void StrCopyINT(unsigned short *Dest, unsigned short *Source, unsigned short length)
{
...
---------------------------------------------------------------*/
void Read_D(unsigned short *ui16_DataD_PLC,
            unsigned short Start_addr,
            unsigned short ui16Read_size)
{
/*-----Variables for PLC Read------- */
    static unsigned short data_d_plc[50]={0};
...
bool        ProcessData(unsigned short *Data_PLC,
